...
def enrollment():
    ...
    # if there is a course ID => we came here from clicking "Enroll" on a course
    if courseID:
        # if user already enrolled to this course
    ...
    # Code from our MongoDB Compass Aggregation Pipeline
