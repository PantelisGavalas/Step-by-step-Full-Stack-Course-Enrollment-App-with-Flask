...
# Class for User collection of our db
...
# Route for users where we add two users and get back 
# the users from the db to pass to the template
@app.route('/user')
def user():
    # We define two users to add in the db 
    # ONLY ONCE SINCE THEIR ID MUST BE UNIQUE
    '''
    ...
    # get back the users from the db
