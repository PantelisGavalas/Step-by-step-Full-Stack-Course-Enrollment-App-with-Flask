...
class GetUpdateDelete(Resource):
    ...
    def put(self, idx):
        data = api.payload
        # Just call the update function on the user with the payload data
        # The system is smart enough to know and change only the ones with difference 
        # between existing and sent data.
